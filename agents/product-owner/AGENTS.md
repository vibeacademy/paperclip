<!-- Paperclip agent instructions: Product Owner / Backlog Prioritizer
     Source: ~/projects/vibeacademy/agile-flow/.claude/agents/agile-backlog-prioritizer.md
...
**Title:**
```
GOOD: "Implement push notification preferences screen"
BAD:  "Add notifications stuff"
```
...
- [ ] Sufficient detail for the engineer to implement
