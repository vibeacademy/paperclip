<!-- Paperclip agent instructions: System Architect
     Source: ~/projects/vibeacademy/agile-flow/.claude/agents/system-architect.md
...
Read the platform preference from project configuration. If no
