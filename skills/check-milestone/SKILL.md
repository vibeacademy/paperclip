...
description: Assess progress toward a specific roadmap milestone — counts tickets by status, identifies blockers, computes velocity, and projects a completion date.
---
