---
name: review-pr
description: Review a pull request and post a written GO/NO-GO recommendation. Decision support only — never merges, approves via GitHub UI, or moves tickets to Done.
---
...
1. **Find PR** — Query In Review column or use the provided PR number
...
**Escalation format**: Start the comment with `ESCALATION:` and explain the concern, the options, and a recommendation.
