---
name: positioning
description: Conduct a product positioning analysis using April Dunford's "Obviously Awesome" framework. Produces a positioning statement, value themes, and messaging pillars. Saved to docs/POSITIONING-ANALYSIS.md.
---

# Positioning Analysis

Use April Dunford's "Obviously Awesome" framework to produce a differentiated, evidence-based positioning analysis.
...
If web search is available, validate positioning claims:
...
**If web search is unavailable:** Skip web validation. Note "Web validation not performed" in the output.
...
> Generated by `positioning` skill on {date}
...
After completing positioning analysis, use the `bootstrap-product` skill to create the PRD — it will read all three research artifacts (market research, JTBD, positioning) and pre-populate 10 of 25 questions automatically.
