---
name: sprint-status
description: Quick sprint status snapshot — counts by column, in-progress work, pending reviews, recent completions, and immediate action items. For daily standups and quick health checks.
---
