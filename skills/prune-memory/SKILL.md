---
name: prune-memory
description: (Memory MCP only) Review stale entities in the Memory MCP knowledge graph and present archival or review candidates. Skip if Memory MCP is not configured. Largely irrelevant in Paperclip — kept for completeness.
---
