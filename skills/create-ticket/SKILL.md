---
name: create-ticket
description: Create a new GitHub project board ticket with the 4 Power Sections (Environment Context, Guardrails, Happy Path, Definition of Done) populated and Definition of Ready met.
---
